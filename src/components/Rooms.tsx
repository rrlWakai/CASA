...
const rooms = [
  {
    ...
    description:
      "The crown jewel of Casa Granada — a spacious master suite with en-suite bath, king bed, and private balcony overlooking the infinity pool.",
    capacity: 2,
    beds: "1 King Bed",
    baths: "1 En-suite",
    size: "45 sqm",
  ...
  },
  {
    ...
    description:
      "A well-appointed room with queen bed and garden views — ideal for couples or close friends seeking comfort and style.",
    capacity: 2,
    beds: "1 Queen Bed",
    baths: "1 Shared",
    size: "30 sqm",
  ...
  },
  {
    ...
    description:
      "Spacious bunk-style room perfect for kids or a group of friends. Fun, functional, and fully air-conditioned.",
    capacity: 4,
  ...
  },
  {
    ...
    description:
      "An airy second-floor loft with sweeping views over the garden and pool — a private perch for those who love light and open spaces.",
    capacity: 3,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-500 text-lg max-w-xl mx-auto">
            Four beautifully designed rooms that can accommodate up to 20 guests
            in total, perfect for families and barkadas alike.
          </p>
        </motion.div>
          ...
          {rooms.map((room, i) => (
            ...
            >
              ...
              <div className="relative h-64 overflow-hidden">
                ...
                {/* Badge */}
                <div
                  className={`absolute top-4 left-4 px-3 py-1.5 ${room.accent} text-white text-xs font-semibold tracking-wider uppercase rounded-full`}
                >
                  {room.tagline}
                </div>
                {/* Capacity */}
        ...
        >
          <p className="font-display text-2xl font-semibold mb-1">
            Casa Granada sleeps up to{" "}
            <span className="text-emerald-200">20 guests</span>
          </p>
          <p className="text-emerald-200/80 text-sm">
            Perfect for family reunions, barkada weekends, corporate retreats,
